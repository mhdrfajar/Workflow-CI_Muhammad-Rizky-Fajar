...
if __name__ == "__main__":
    ...
    # Menggunakan model LogisticRegression karena memiliki performa terbaik pada tahapan 
    # Kriteria 2 berdasarkan F1-Score
    ...
    if model_type == "LogisticRegression":
        ...
        params = {"C": 1.0, "solver": "liblinear"} #Best hyperparameter logistic regression
    else: # RandomForestClassifier
        model = RandomForestClassifier(n_estimators=100, max_depth=10, random_state=42, class_weight='balanced')
        params = {"n_estimators": 100, "max_depth": 10} #Best hyperparameter random forest
